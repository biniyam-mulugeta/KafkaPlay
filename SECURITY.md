...
Report privately through [GitHub Security Advisories](https://github.com/<owner>/kafkaplay/security/advisories/new), which lets us discuss and fix the issue before it becomes public.
